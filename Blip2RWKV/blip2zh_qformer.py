...
if __name__ == "__main__":
    blip2baseZh = Blip2BaseZh()

    tokenizer = blip2baseZh.init_tokenizer()
    #print(tokenizer)

    Qformer, query_tokens =  blip2baseZh.init_Qformer(num_query_token=1024,vision_width=768)
    #print(Qformer)
    #print(query_tokens)

    test_sentence = '你好，介绍下你自己.'
    #testinput = tokenizer(test_sentence)['input_ids']
    #print(testinput)

    text = tokenizer(test_sentence, return_tensors="pt", padding=True)
    blip2Zhqformer = Blip2ZhQformer()
    print(blip2Zhqformer.forward_text(text))